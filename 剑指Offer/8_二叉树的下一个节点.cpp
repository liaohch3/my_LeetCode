/*
* @Author: liaohch3
* @Date:   2020-02-19 11:54:19
* @Last Modified by:   liaohch3
* @Last Modified time: 2020-02-19 12:25:34
*/
...
void ConnectTreeNodes(BinaryTreeNode* m_pParent, BinaryTreeNode* pLeft, BinaryTreeNode* pRight)
{
    if(m_pParent != nullptr)
    {
        m_pParent->m_pLeft = pLeft;
        m_pParent->m_pRight = pRight;
...
void PrintTreeNode(BinaryTreeNode* pNode)
{
    if(pNode != nullptr)
    {
        ...
        if(pNode->m_pRight != nullptr)
            printf("value of its m_pRight child is: %d.\n", pNode->m_pRight->m_nValue);
        else
            printf("m_pRight child is null.\n");
    }
    else
    {
